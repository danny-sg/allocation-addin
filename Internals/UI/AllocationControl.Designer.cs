namespace SqlInternals.AllocationInfo.Internals.UI
{
    ...
    partial class AllocationControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            var resources =
                new System.ComponentModel.ComponentResourceManager(typeof(AllocationControl));
            ...
            this.statusStrip.Items.AddRange(
                new ToolStripItem[] { this.allocUnitProgressBar, this.allocUnitToolStripStatusLabel });
            ...
            this.allocationDataGridView.CellBorderStyle = System.Windows.Forms.DataGridViewCellBorderStyle
                .SingleHorizontal;
            this.allocationDataGridView.ColumnHeadersHeightSizeMode =
                System.Windows.Forms.DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            this.allocationDataGridView.Columns.AddRange(
                new DataGridViewColumn[]
                    {
                        this.KeyColumn, this.ObjectNameTextBoxColumn, this.RowsTextBoxColumn, this.SpaceUsedColumn,
                        this.TotalSpaceMbTextBoxColumn, this.UsedSpaceMbTextBoxColumn, this.DataSpaceMbTextBoxColumn,
                        this.AvgFragColumn
                    });
            ...
            this.allocationDataGridView.CellClick +=
                new System.Windows.Forms.DataGridViewCellEventHandler(this.AllocationDataGridView_CellClick);
            this.allocationDataGridView.SelectionChanged +=
                new System.EventHandler(this.AllocationDataGridView_SelectionChanged);

            // KeyColumn
            this.KeyColumn.DataPropertyName = "KeyColour";
            this.KeyColumn.Frozen = true;
            this.KeyColumn.HeaderText = string.Empty;
            ...
            this.TotalSpaceMbTextBoxColumn.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode
                .ColumnHeader;
            ...
            this.UsedSpaceMbTextBoxColumn.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode
                .ColumnHeader;
            ...
            this.DataSpaceMbTextBoxColumn.AutoSizeMode = System.Windows.Forms.DataGridViewAutoSizeColumnMode
                .ColumnHeader;
            ...
            this.keyImageColumn1.HeaderText = string.Empty;
            ...
            this.flatMenuStrip.Items.AddRange(
                new ToolStripItem[]
                    {
                        this.toolStripLabel1, this.databaseComboBox, this.refreshToolStripButton,
                        this.toolStripSeparator2, this.bufferPoolToolStripButton, this.toolStripSeparator1,
                        this.toolStripLabel2, this.extentSizeToolStripComboBox, this.mapToolStripButton,
            ...
            this.databaseComboBox.SelectedIndexChanged +=
                new System.EventHandler(this.DatabaseComboBox_SelectedIndexChanged);

            // refreshToolStripButton
            this.refreshToolStripButton.DisplayStyle = System.Windows.Forms.ToolStripItemDisplayStyle.Image;
            this.refreshToolStripButton.Image =
                (System.Drawing.Image)resources.GetObject("refreshToolStripButton.Image");
            ...
            this.bufferPoolToolStripButton.Image =
                (System.Drawing.Image)resources.GetObject("bufferPoolToolStripButton.Image");
            ...
            this.bufferPoolToolStripButton.CheckStateChanged +=
                new System.EventHandler(this.BufferPoolToolStripButton_Click);
            ...
            this.extentSizeToolStripComboBox.Items.AddRange(new object[] { "Small", "Medium", "Large", "Fit" });
            ...
            this.extentSizeToolStripComboBox.SelectedIndexChanged +=
                new System.EventHandler(this.ExtentSizeToolStripComboBox_SelectedIndexChanged);
            ...
            this.mapToolStripButton.CheckStateChanged +=
                new System.EventHandler(this.MapToolStripButton_CheckStateChanged);
            ...
            this.infoTableContextMenuStrip.Items.AddRange(
                new ToolStripItem[] { this.toolStripMenuItem1, this.advancedToolStripMenuItem });
            ...
            this.allocUnitBackgroundWorker.DoWork +=
                new System.ComponentModel.DoWorkEventHandler(this.AllocUnitbackgroundWorker_DoWork);
            this.allocUnitBackgroundWorker.RunWorkerCompleted +=
                new System.ComponentModel.RunWorkerCompletedEventHandler(
                    this.AllocUnitbackgroundWorker_RunWorkerCompleted);
            this.allocUnitBackgroundWorker.ProgressChanged +=
                new System.ComponentModel.ProgressChangedEventHandler(this.AllocUnitbackgroundWorker_ProgressChanged);

            // advancedInfoBackgroundWorker
            this.advancedInfoBackgroundWorker.WorkerSupportsCancellation = true;
            this.advancedInfoBackgroundWorker.DoWork +=
                new System.ComponentModel.DoWorkEventHandler(this.AdvancedInfoBackgroundWorker_DoWork);
            this.advancedInfoBackgroundWorker.RunWorkerCompleted +=
                new System.ComponentModel.RunWorkerCompletedEventHandler(
                    this.AdvancedInfoBackgroundWorker_RunWorkerCompleted);
            this.advancedInfoBackgroundWorker.ProgressChanged +=
                new System.ComponentModel.ProgressChangedEventHandler(
                    this.AdvancedInfoBackgroundWorker_ProgressChanged);
        ...
        private ToolStripButton mapToolStripButton;
        ...
        private BackgroundWorker advancedInfoBackgroundWorker;
        private KeyImageColumn KeyColumn;
        private DataGridViewTextBoxColumn ObjectNameTextBoxColumn;
        private DataGridViewTextBoxColumn RowsTextBoxColumn;
        private BarImageColumn SpaceUsedColumn;
        private DataGridViewTextBoxColumn TotalSpaceMbTextBoxColumn;
        private DataGridViewTextBoxColumn UsedSpaceMbTextBoxColumn;
        private DataGridViewTextBoxColumn DataSpaceMbTextBoxColumn;
