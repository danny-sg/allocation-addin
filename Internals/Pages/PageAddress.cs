...
namespace SqlInternals.AllocationInfo.Internals.Pages
{
    ...
    /// </summary>
    /// <remarks>
    /// A page address uniquely identifies a page in a database. It consists of a Page Id and File Id
    /// </remarks>
    [Serializable]
    public struct PageAddress : IEquatable<PageAddress>, IComparable<PageAddress>
    {
        ...
        ///     Value Meaning Less than zero This object is less than the <paramref name="other"/> parameter.Zero 
